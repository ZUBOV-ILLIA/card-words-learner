...
export default function Practice() {
  ...
  return (
    <div className="relative flex justify-center items-center grow w-full rounded-lg overflow-hidden">
      {!needToShuffleWords &&
      ...
      {randomWordsList.length > 0 ? (
        ...
        <p className="self-start text-gray-400 font-thin text-center">
